...
import DrawingManager from './extra/DrawingManager.vue'


export default {
  install(Vue, options) {
    // const { ak } = options
    Vue.prototype._BMap = () => ({ '1': '22' })
...
export {
  ...
  BmTile, BmTraffic,
  BmBoundary, BmAutoComplete, DrawingManager
}
