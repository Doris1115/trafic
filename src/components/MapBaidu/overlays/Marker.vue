...
export default {
  ...
  methods: {
    load() {
      const { BMap, map, position, offset, icon, massClear, dragging, clicking, raiseOnDrag, draggingCursor, rotation, shadow, title, label, animation, top, renderByParent, $parent, zIndex, onClick, data } = this
      ...
      this.originInstance.addEventListener('click', function (e) {
        onClick(e, data, position)
      })
      // this.originInstance.addEventListener('mouseover', function (e) {
      //   onMouseover(e, data)
      // })
