  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','alarmcasePhoto:edit','alarmcasePhoto:del']" label="操作" width="150px" align="center">
...
<script>
import crudAlarmcasePhoto from '@/api/alarmcasePhoto'
...
const defaultForm = { casephotoId: null, tid: null, photoInfo: null, photoDesc: null, porder: null }
export default {
  name: 'AlarmcasePhoto',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: 'v1/api/duty/alarm_case_photo', url: 'api/alarmcasePhoto', sort: 'casephotoId,desc', crudMethod: { ...crudAlarmcasePhoto }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'alarmcasePhoto:add'],
        edit: ['admin', 'alarmcasePhoto:edit'],
        del: ['admin', 'alarmcasePhoto:del']
      },
      rules: {
      },
      queryTypeOptions: [
